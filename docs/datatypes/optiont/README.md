...
optTVal
//OptionT(value=ObservableKW(observable=io.reactivex.internal.operators.observable.ObservableJust@315cab4e))
```
...
optTVal
//OptionT(value=ObservableKW(observable=io.reactivex.internal.operators.observable.ObservableJust@64c3c7d4))
```
...
```kotlin
optTVal.value()
//ObservableKW(observable=io.reactivex.internal.operators.observable.ObservableJust@64c3c7d4)
```
