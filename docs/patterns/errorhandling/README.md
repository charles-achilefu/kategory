...
//kategory.OptionMonadErrorInstanceImplicits$instance$1@1b4a2a05
```

```kotlin
monadError<TryHK, Throwable>()
//kategory.TryMonadErrorInstanceImplicits$instance$1@73d83b8d
```

```kotlin
monadError<EitherKindPartial<NukeException>, NukeException>()
//kategory.EitherMonadErrorInstanceImplicits$instance$1@13914177
```
